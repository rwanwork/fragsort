...
#
#   Boost_REALPATH               Resolves symbolic links for discovered
#                                boost libraries for packaging. E.g.
#                                /usr/lib/libboost_filesystem.so.1.42.0 instead
#                                of /usr/lib/libboost_filesystem.so
#                                  [Since CMake 2.8.3]
#
  ...
  FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
    ...
    if(Boost_REALPATH)
      ...
      if(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE) # was it found ?
        ...
        set(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE ${_boost_filepathreal})
      ...
      if(Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG) # was it found ?
        ...
        set(Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG ${_boost_filepathreal})
